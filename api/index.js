...
Geef exact 5 kansen totaal, \xE9\xE9n per categorie in deze volgorde: "Artikeldata", "Klantadvies", "Logistiek & voorraad", "Duurzaamheid & circulariteit", "Commerci\xEBle waarde". Priority-waarden zijn: "Quick win", "Strategische kans", "Later onderzoeken", "Niet direct relevant". Alle scores zijn integers van 1-10.

Voor het veld marketContext gelden deze regels:
- maturity: kies exact \xE9\xE9n van "Nog niet", "In opkomst", "Bestaat generiek", "Volwassen markt". "Nog niet" = geen bekende tools; "In opkomst" = eerste startups/pilots; "Bestaat generiek" = generieke oplossingen die niet specifiek voor deze branche/materiaal zijn getraind; "Volwassen markt" = meerdere gevestigde aanbieders met branchefocus.
...
- gap: leg in \xE9\xE9n of twee zinnen uit wat er nog mist voor DIT specifieke materiaal, deze keten of deze organisatie. Waarom is er nog ruimte om zelf iets op te bouwen.
